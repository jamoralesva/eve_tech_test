...
{
"decision": "TEXT_STRING" ("ALLOW", "ALERT", or "BLOCK"),
...
class ValidatorBase(ABC):
    ...
    @abstractmethod
    def validate(self, prompt: str) -> FutureResult[PartialValidation, FailedValidation]:
        pass
...
class OllamaValidatorBase(ValidatorBase):
    ...
    @future_safe
    async def _validate(self, policy_context: str) -> PartialValidation:
    ...
    def validate(self, policy_context: str) -> FutureResult[PartialValidation, FailedValidation]:
